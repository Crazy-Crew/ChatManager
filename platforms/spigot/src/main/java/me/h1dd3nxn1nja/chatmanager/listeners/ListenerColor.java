...
public class ListenerColor implements Listener {
	...
	private String formatChat(Player player, String string) {
	...
	private String replaceColor(char colorChar, String string) {
        String specific = "0123456789AaBbCcDdEeFf";

        return replaceSpecific(colorChar, specific, string);
    }

    private String replaceFormat(char colorChar, String string) {
