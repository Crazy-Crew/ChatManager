...
public class RootKeys implements SettingsHolder {
    ...
    public void registerComments(@NotNull CommentsConfiguration configuration) {
        ...
        configuration.setComment("root.errors", header);
    }
    ...
    public static final Property<String> must_be_a_player = newProperty("root.player.requirements.must-be-player", "{prefix}<red>You must be a player to use this command.");

    public static final Property<String> must_be_console_sender = newProperty("root.player.requirements.must-be-console-sender", "{prefix}<red>You must be using console to use this command.");

    @Comment("A list of available placeholders: {player}")
    public static final Property<String> not_online = newProperty("root.player.target-not-online", "{prefix}<red>{player} <gray>is not online.");

    public static final Property<String> same_player = newProperty("root.player.target-same-player", "{prefix}<red>You cannot use this command on yourself.");

    public static final Property<String> no_permission = newProperty("root.player.no-permission", "{prefix}<red>You do not have permission to use that command!");
