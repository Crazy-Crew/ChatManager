...
public class PlaceholderManager {
	...
	public static String setPlaceholders(Player player, String placeholders) {
		...
		placeholders = Methods.color(player, placeholders.replace("{Prefix}", Main.settings.getMessages().getString("Message.Prefix")));
		placeholders = Methods.color(player, placeholders.replace("{prefix}", Main.settings.getMessages().getString("Message.Prefix")));
		...
		placeholders = Methods.color(player, placeholders.replace("{server_name}", Main.settings.getConfig().getString("Server_Name")));
