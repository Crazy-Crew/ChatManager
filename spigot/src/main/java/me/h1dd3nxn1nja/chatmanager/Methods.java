...
public class Methods {
    ...
    public static void sendMessage(CommandSender commandSender, String message, boolean prefixToggle) {
        ...
        if (commandSender instanceof Player) {
            ...
            if (prefix != null && !prefix.isEmpty() && prefixToggle)
                player.sendMessage(color(message.replace("{Prefix}", prefix)));
        ...
        if (prefix != null && !prefix.isEmpty() && prefixToggle)
            commandSender.sendMessage(color(message.replace("{Prefix}", prefix)));
    ...
    public static void broadcast(String message) {
        ...
        if (prefix != null && !prefix.isEmpty())
            plugin.getServer().broadcastMessage(color(message.replace("{Prefix}", prefix)));
        else plugin.getServer().broadcastMessage(color(message));
    }
