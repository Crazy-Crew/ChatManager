package com.ryderbelserion.chatmanager.configs.migrate.manuel;
...
public class DefaultMigration implements Universal {

    public void convert(boolean deleteFile) {
        copyFilterSettings(deleteFile);
    }

    private void copyFilterSettings(boolean deleteFile) {
