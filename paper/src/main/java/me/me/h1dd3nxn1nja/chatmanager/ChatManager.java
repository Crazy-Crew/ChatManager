  ...
  private Metrics metrics;
	...
	public void onDisable() {
		...
		for (Player all : Bukkit.getOnlinePlayers()) {
			me.h1dd3nxn1nja.chatmanager.Methods.cm_chatCooldown.remove(all);
			me.h1dd3nxn1nja.chatmanager.Methods.cm_cooldownTask.remove(all);
			me.h1dd3nxn1nja.chatmanager.Methods.cm_commandCooldown.remove(all);
			me.h1dd3nxn1nja.chatmanager.Methods.cm_cooldownTask.remove(all);
		...
		if (settings.getConfig().getBoolean("Chat_Radius.Enable")) {
			for (Player all : Bukkit.getOnlinePlayers()) {
				if (settings.getConfig().getString("Chat_Radius.Default_Channel").equalsIgnoreCase("Local")) {
					me.h1dd3nxn1nja.chatmanager.Methods.cm_localChat.add(all.getUniqueId());
				} else if (settings.getConfig().getString("Chat_Radius.Default_Channel").equalsIgnoreCase("Global")) {
					me.h1dd3nxn1nja.chatmanager.Methods.cm_globalChat.add(all.getUniqueId());
				} else if (settings.getConfig().getString("Chat_Radius.Default_Channel").equalsIgnoreCase("World")) {
					me.h1dd3nxn1nja.chatmanager.Methods.cm_worldChat.add(all.getUniqueId());
				}
			}
		}
	}
	...
	public boolean setupPermissionsPlugin() {
		if (me.h1dd3nxn1nja.chatmanager.Methods.doesPluginExist("LuckPerms") ||
				me.h1dd3nxn1nja.chatmanager.Methods.doesPluginExist("PermissionsEx") ||
				me.h1dd3nxn1nja.chatmanager.Methods.doesPluginExist("GroupManager") ||
