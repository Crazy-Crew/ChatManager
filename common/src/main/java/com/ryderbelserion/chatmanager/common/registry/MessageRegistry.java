...
public class MessageRegistry implements IMessageRegistry {
    ...
    public void init() {
        ...
        addMessage(MessageKeys.join_message, new Message(" <dark_gray>[<green>+</green>]</dark_gray> {player}", "messages", "traffic", "join_message"));
        addMessage(MessageKeys.quit_message, new Message(" <dark_gray>[<red>-</red>]</dark_gray> {player}", "messages", "traffic", "quit_message"));

        addMessage(MessageKeys.message_of_the_day, new Message(StringUtils.toString(List.of(
                "<gray>------------------------------------",
                "",
